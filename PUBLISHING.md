...
4. The extension is now installed for your current session! It will appear in your toolbar.
   _Note: Temporary add-ons in Firefox are automatically removed when you close the browser._
...
4. Upload your `yt-dedupe-firefox.zip` file.
   - _Note: The Mozilla automated validator will scan it. Because we correctly injected the `gecko.id` into the manifest via our Turborepo build process, it will pass automatically._
